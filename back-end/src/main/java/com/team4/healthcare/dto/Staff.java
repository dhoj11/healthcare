...
public class Staff {
	...
	public String toString() {
		return "Staff [staff_id=" + staff_id + ", staff_password=" + staff_password + ", staff_authority="
				+ staff_authority + ", hospital_code=" + hospital_code + ", staff_name=" + staff_name + ", staff_tel="
				+ staff_tel + ", staff_enabled=" + staff_enabled + ", staff_join=" + staff_join + ", staff_pic="
				+ staff_pic + ", staff_pic_oname=" + staff_pic_oname + ", staff_pic_sname=" + staff_pic_sname
