...
export function isReserved(hospital_code, staff_id, appointment_date) {
  const promise = axios.get("http://localhost:8080/administration/appointment/treatment/time", {params:{hospital_code, staff_id, appointment_date}});
  return promise;
}
...
export function CountbyAppointment(hospital_code, appointment_date) {
  const promise = axios.get("http://localhost:8080/administration/appointment/test/time", {params:{hospital_code, appointment_date}});
  return promise;
}
...
export function getTestReceptionListByState(reception_state) {
  const promise = axios.get("http://localhost:8080/administration/reception/test/state", {params:{reception_state}});
  return promise;
}
